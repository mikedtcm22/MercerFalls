...
status: canonical
visibility: dm-only
aliases: [Episode Catalog, Episodes MOC]
tags: [embers, moc, episodes]
source: ["wesley bizarro plot v5 §7 (lines 231–451)", "campaign bible v0.4 §17, §19"]
created: 2026-06-14
---
...
| [[Episode 5 — Storm-That-Doesn't-Move]] | Late July – early Aug | [[Sam]] (emerges here) |
| [[Episode 6 — First Real Wesley Suspicion]] | Mid-August | — (pattern comes into focus) |
| [[Episode 7 — The Breather]] | Late August | — (Wesley-free bottle) |
| [[Episode 8 — Wesley Confirmed]] | Early Sept (school starts) | — (click 2) |
| [[The Equinox Arc]] | Mid–late Sept (climax 9/22) | all recruits + [[Sam]] |
...
- **[[Episode 5 — Storm-That-Doesn't-Move]]** — Mike Tinsmith's hollowing cornerstone; the dock residue-storm; Sam emerges; Wesley's name surfaces.
- **[[Episode 6 — First Real Wesley Suspicion]]** — Doug hollowed (first Weight attempt fails); the pattern becomes hard to miss.
- **[[Episode 7 — The Breather]]** — Wesley-free bottle episode for planning and relationship maintenance.
- **[[Episode 8 — Wesley Confirmed]]** — school starts; Phyllis hollowed (Weight retrieved); click 2; negotiation goes explicit.
- **[[The Equinox Arc]]** — figure out the ritual, locate the mansion, choose disruption, the negotiation-as-combat climax.

## Auto-index
```dataview
LIST
FROM ""
WHERE domain = "Episodes" AND file.name != this.file.name
SORT type ASC, file.name ASC
```

## Source
Wesley Bizarro Plot v5 §7 (Episode Catalog, lines 231–451); Campaign Bible v0.4 §17 (Session 1), §19 (Onboarding), §16 (Session Length).
