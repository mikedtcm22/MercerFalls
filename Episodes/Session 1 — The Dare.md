...
**Block 4 — Pre-cleared floor & buzzsaw.** They follow [[Wesley Crane]]'s footprints and chalk through rooms he cleared on a recent solo delve; a manageable first combat. The trail ends at the **Buzzsaw Room**: ash-stains in human shapes, an active sigil ([[Wesley's Sigils]] — first real one), and a robed figure finishing the inscription. DC 15 Perception for a clear look at his unremarkable face. He says one ambiguous line — *"You poor things"* — triggers the sigil, and steps through the door (the PCs don't yet know he teleported home). The engineered wave hits: 3–4 weak creatures → escalation → a ~25-HP lieutenant (+5, 1d8+2, advantage aura) → TPK-likely. **The Sigil Escape Window**: for 1–2 minutes a PC who reads the situation can ride out the exit-side door.
