...
aliases: [Time Points, Day/Night Pools, The Money Loop, Threshold Pricing]
tags: [embers, system, town-mode, time, economy]
source: ["campaign bible v0.4 §8"]
created: 2026-06-14
---
...
The DM sets the budget per day based on what's happening.

| Day type | Day pts | Night pts |
|---|---|---|
| School/work weekday | 2 | 2 |
| Saturday or off day | 4 | 2 |
| Special day (school break, holiday, snow day) | 5–6 | 2 |
| Summer vacation | 4 | 2 |

## PC Backstory Modifiers (examples)

- **Strict parents:** −1 Night
- **After-school job:** −1 Day on workdays
- **Lax household / lives alone:** +1 Night
- **Athletic team in season:** −1 Day on practice days

## Threshold Pricing

Most activities use thresholds, not flat costs — **spending more buys depth, not just success.** PCs declare their target tier upfront and can stop early (spending 2 on a planned 3 nets the 2-tier result).

| Activity | 1 pt | 2 pts | 3–4 pts |
|---|---|---|---|
| Visit NPC | Check-in: a beat, maintain | Real talk: 1 relationship advance, meaningful info | Extended: 2 advances, favor or revelation |
| Investigate a place | Glance: confirm/deny one fact | Search: 1–2 finds | Comb through: everything available |
| Practice/study | Stay sharp | Modest gain (+1 to next related check) | Real progress |
| Trip to neighboring town | — | — | Day trip: 3–4 Day |
