---
title: Next Prep Targets
type: dm-os
domain: DM-OS
status: provisional
visibility: dm-only
aliases: [Prep Backlog, Prep Targets, Next Prep]
tags: [embers, dm-os, prep, backlog, planning]
source: ["campaign bible v0.4 §21"]
created: 2026-06-14
---
...
**The priority-ordered prep backlog, Tiers 1–7, sequenced by when each item is needed. Tiers can run in parallel where they don't depend on each other.**

> [!note] Status: provisional
> A living backlog. The next major bible revision is expected to be triggered by PC creation or by completing Episode 1's detailed prep, which will close many of these.

## Tier 1 — Before Sending the Character Creation Guide

- Decide whether to split Session 1 across [[Session 0]] + [[Session 1 — The Dare]] (S0 as char-creation-only, or weave char creation through the dare/chase).
- The **light pitch paragraph** to send with the [[Character Creation Guide]] — concept, tone, time commitment, real-time scheduling. The title goes in unexplained. See [[The Campaign Pitch]].
