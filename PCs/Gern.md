...
## Battle plan
- **Through-line — Belonging on Offer (two ways to lose conviction).** Gern's temptation doesn't arrive as an object (the way [[Bash Whitlock|Bash]]'s does through his gear) or as his own voice (the way [[Old Man]]'s does) — it arrives as **belonging**, and he can forfeit his convictions in *two opposite directions*:
  - *Toward Order* — accept a seat by **dimming himself** to fit a structured group that rewards conformity: his parents' church first, but also any clique or institution that offers warmth on the condition he not be *too much himself*.
  - *Toward Chaos* — **throw all conviction away** and call the void freedom (see Crisis).
  Both leave him surrounded and unseen; the recurring shape is Gern trading conviction — suppressing it for a crowd, or abandoning it wholesale — and ending up alone in a room. He *understands* [[Wesley's Recruits|the recruits]]' hunger because he shares it, which is the seed of a dedicated foil later (a Wesley-orbit zealot — the kid who took the Order-belonging seat and became a true believer; **Rival design, deferred**).
...
- **Crisis & turn — the destructive rebellion (toward Chaos), then discernment.** Handed his first real alternative to his parents' faith, Gern **tears the inherited religion down and reaches for "freedom"** — and for Gern the Chaos jaw isn't another structure, it's the **dissolution of all conviction**: nothing is true, nothing is owed, belong to no one, do as you like. He mistakes that void for liberation — his on-screen "broke bad," the destructive-rebellion phase the arc runs *through*, not around. Crucially he **does not lurch toward [[Wesley Crane|Wesley]] / [[The Community Center]]** — that's its own *Order* (a structured belonging under the opposite patron); swapping his parents' cage for Wesley's wouldn't be rebellion, just relocation. His rebellion points *away* from every authority, toward formless "do whatever." The **turn** is discernment: he learns the void is **also** agency-loss — a self with no convictions has nothing for anyone to meet and can't really choose anything either, just follow appetite. He **reclaims a life of conviction — chosen, defensible, his —** and the connection that survives the clash turns out to be the one that was real all along. Cleric beat to hit at the turn: his power stops feeling borrowed.
- **Reserve assets.**
  - **His parents / the church** — the **Order** lever; they'll take him back if he stops asking questions. Aim it when he's most lost (right after the rebellion crests).
  - **The amenities / purchased-belonging pattern** — a fast, legible way to dramatize hollow connection without touching cosmology.
