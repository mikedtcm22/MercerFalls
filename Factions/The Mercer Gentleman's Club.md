---
title: The Mercer Gentleman's Club
type: faction
domain: Factions
status: provisional
visibility: mixed
aliases: [The Gentleman's Club, Mercer's Occult Club]
tags: [embers, faction, heights, mercer, history]
source: ["campaign bible v0.4 §2", "campaign bible v0.4 §20", "town reference v0.3 §9"]
created: 2026-06-14
---

# The Mercer Gentleman's Club

Up: [[Factions & Groups]]

**The small, persistent occult gentleman's club [[Elias Mercer]] belonged to when he founded Mercer Falls in 1887 — whose attenuated descendants still live in town, mostly up in [[The Districts|the Heights]].**

## Established facts
- Elias Mercer was an industrialist with a private library of occult texts and **a member of a small, persistent gentleman's club whose attenuated descendants still exist in town** (Bible §2).
- Those descendants sit among the old-money families on the lake's north and east shores — the Heights — alongside the doctors, lawyers, the bank president, and the funeral-home owner, families three or four generations deep in Mercer Falls (Town Ref §9). The Heights is largely insulated from the hollowing (see [[Hollowing and Agency-Loss]]) by distance from the dungeon and non-mill-dependent wealth.
